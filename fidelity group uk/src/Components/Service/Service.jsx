...
import s2 from '../assets/Img/2.jpg';
import s3 from '../assets/Img/3.jpg';
import s4 from '../assets/Img/4.jpg';
import s5 from '../assets/Img/5.jpg';
import s6 from '../assets/Img/6.jpg';
import s7 from '../assets/Img/7.jpg';
import s8 from '../assets/Img/8.jpg';
  ...
  return (
    ...
    <div className="header">
          <div className="h-left">
              <div className='sstar-f'>
                <a href='#' className='sstar'>
      ...
      <p><i className="ri-money-dollar-box-fill"></i> Become a Reseller</p>
      <p><i className="ri-user-3-fill"></i> anvil login</p>
      </div>
    </div>
    <Navbar/>
    ...
    <div className="serv-txt">
      <h5>Customer inspired software, telecoms and energy services in the UK.</h5>
      <h1>Empowering <mark>everything as a service</mark>.</h1>
    </div>

      <div className='cards'>
    
    <a href="https://www.fidelity-group.co.uk/data-and-connectivity/">
    <div className='card'>
      <div className='c-img'>
      <img src={s1} alt="" />
      </div>
      <div>
      <p>Connect like a pro. <strong>Get super fast and reliable business broadband and ethernet connectivity.</strong></p>
      </div>
    </div>
    </a>
    
    <a href="https://www.fidelity-group.co.uk/energy-service/">
        ...
        <img src={s2} alt="" />
          ...
          <div>
          <p>We have the know how. <strong>Let us procure and manage your business energy requirements.</strong></p>
          </div>
        </div>
    </a>

    <a href="https://www.fidelity-group.co.uk/mobile-services/">
    <div className='card'>
      <div className='c-img'>
      <img src={s3} alt="" />
      </div>
      <div>
        <p>Let your business roam with us. <strong>We have business mobile plans and service that won&apos;t let you down.</strong></p>
      </div>
    </div>
    </a>

     <a href="https://www.fidelity-group.co.uk/iot-connectivity-management-platform-vm2m/">
    <div className='card'>
      <div className='c-img'>
      <img src={s4} alt="" />
      </div>
      <div>
        <p>IoT is changing the way we do business. <strong>We can manage volume of SIMs that connect to a range of different devices via mobile connectivity.</strong></p>
      </div>
    </div>
     </a> 

    <a href="https://www.fidelity-group.co.uk/cloud-and-hosting/">
    <div className='card'>
      <div className='c-img'>
      <img src={s5} alt="" />
      </div>
      <div>
        <p>Get your business &apos;in the cloud&apos;. <strong>We build and implement bespoke cloud strategies to enhance your business operations and save on costs.</strong></p>
      </div>
    </div>
    </a>
    
    <a href="https://www.fidelity-group.co.uk/hosted-telephony/">
    <div className='card'>
      <div className='c-img'>
      <img src={s6} alt="" />
      </div>
      <div>
       <p>Communicate like a king! <strong>Let&apos;s get your business using the latest VoIP and cloud solutions.</strong></p>
      </div>
    </div>
    </a>

    <a href="https://www.fidelity-group.co.uk/payments/">
    <div className='card'>
      <div className='c-img'>
      <img src={s7} alt="" />
      </div>
      <div>
        <p>We are experts in saving business money with <strong>state-of-the-art payment software solutions and technology.</strong></p>
      </div>
    </div>
    </a>

    <a href="https://www.fidelity-group.co.uk/partners/">
    <div className='card'>
      <div className='c-img'>
      <img src={s8} alt="" />
      </div>
      <div>
        <p>Become a reseller. <strong>Benefit from a compelling margin share and an opportunity to drive new digital revenues with unique product offerings.</strong></p>
      </div>
    </div>
    </a>
      </div>

      <h4>Get the <mark>X factor</mark> for your business today. <mark>Start Now!</mark></h4>
    </div>

    <div className="after-serv">
      <div className="a-left">
        <div className="s-l-txt">
          <h5>do not settle for less. partner with best.</h5>
          <h1>Become a <mark>partner</mark> and re-sell our range of products and services.</h1>
        </div>
        <button>Get Copy Now</button>
      </div>
      ...
      <div className="before-bottom">
      <div className="b-left">
        <div className="b-l-txt">
          <h1><mark>Award winning</mark> solutions and services. We thrive for <mark>success</mark>.</h1>
        </div>
      </div>
      <div className="b-right">
        <button>Get a quote</button>
          ...
          <button id='last-btn'>Become a Partner <i className="ri-arrow-right-line"></i></button>
